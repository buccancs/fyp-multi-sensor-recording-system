...
def main():
    parser = argparse.ArgumentParser(description=
        'Multi-Sensor Recording System Web Dashboard', formatter_class=
...
Examples:
  ...
  python web_launcher.py --debug
    ...
    parser.add_argument('--host', '-H', type=str, default='0.0.0.0', help=
        'Host address to bind to (default: 0.0.0.0 for all interfaces)')
    parser.add_argument('--debug', '-d', action='store_true', help=
        'Enable debug mode')
    parser.add_argument('--no-demo-data', action='store_true', help=
    ...
    print()
    try:
        integration = WebDashboardIntegration(enable_web_ui=True, web_port=
            args.port)
