...
class TestJsonSocketServer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.server = JsonSocketServer(host='127.0.0.1', port=9001)  # Use different port for testing
...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_complete_device_lifecycle(self):
        ...
        self.server.preview_frame_received.connect(track_signal('preview_frame_received'))
