...
Generated at: {datetime.now().isoformat()}"""
        ...
        def api_files_content():
            try:
                ...
                if not file_path:
                    return (
                        jsonify({"success": False, "error": "No file path provided"}),
                        400,
                    )
                if os.path.exists(file_path) and os.path.isfile(file_path):
                    try:
                        ...
                        return (
                            jsonify({"success": False, "error": "Cannot read file"}),
                            403,
                        )
                else:
        ...
        def api_files_delete_multiple():
            try:
                ...
                return jsonify(
                    {"success": True, "message": f"Deleted {len(files)} files"}
                )
            except Exception as e:
        ...
        def api_files_open_external():
            try:
                ...
                return jsonify(
                    {"success": True, "message": "File opened in external application"}
                )
            except Exception as e:
        ...
        def api_files_upload():
            try:
                ...
                return jsonify(
                    {"success": True, "message": f"Uploaded {len(files)} files"}
                )
            except Exception as e:
        ...
        def api_settings_reset():
            try:
                ...
                return jsonify(
                    {"success": True, "message": "Settings reset to defaults"}
                )
            except Exception as e:
        ...
        def api_settings_create_backup():
            try:
                ...
                return jsonify(
                    {"success": True, "message": f"Backup created: {backup_name}"}
                )
            except Exception as e:
        ...
        def api_settings_delete_backup(backup_name):
            try:
                ...
                return jsonify(
                    {"success": True, "message": f"Backup deleted: {backup_name}"}
                )
            except Exception as e:
