...
from protocol import (
    get_config_manager, get_schema_manager, validate_config,
    get_valid_message_types, create_message
)
...
class ConfigIntegrityTester:
    ...
    def __init__(self):
        ...
        self.optional_sections = ['session', 'logging', 'testing', 'performance', 'security']
    ...
    def test_devices_config_structure(self) -> bool:
        ...
        if 'resolution' in devices:
            ...
            if (not isinstance(resolution['width'], int) or 
                not isinstance(resolution['height'], int) or
    ...
    def test_calibration_config_structure(self) -> bool:
        ...
        required_keys = ['pattern_rows', 'pattern_cols', 'square_size_m', 'error_threshold']
    ...
    def test_config_cross_validation(self) -> bool:
        ...
        if 'resolution' in devices and 'preview_resolution' in devices:
            ...
            if (preview_res['width'] > main_res['width'] or 
                preview_res['height'] > main_res['height']):
...
class SchemaIntegrityTester:
    ...
    def test_invalid_message_rejection(self) -> bool:
        ...
        invalid_messages = [
            ...
            {'type': 'preview_frame', 'timestamp': 1234567890000, 'frame_id': 'invalid', 
...
def test_message_creation():
    ...
    preview_msg = create_message('preview_frame', frame_id=1, 
                                image_data='test_data', width=640, height=480)
...
def test_config_schema_consistency():
    ...
    cal_msg = create_message('calibration_start',
...
if __name__ == "__main__":
    ...
    config_tests = [
        ...
        ("Calibration config structure", config_tester.test_calibration_config_structure),
