...
class FakeAndroidDevice:
    ...
    def __init__(self, device_id: str = "fake_device_001", 
    ...
    def connect(self, timeout: float = 10.0) -> bool:
        ...
        try:
            ...
            logger.info(f"Fake device {self.device_id} connected to {self.host}:{self.port}")
            return True
    ...
    def _handle_start_record(self, message: Dict[str, Any]) -> None:
        ...
        # Send acknowledgment
        ack_msg = create_message('ack', 
                               message_id=str(message.get('timestamp', 0)),
                               success=True)
        self._send_message(ack_msg)
        
        # Start sending preview frames
        self.preview_thread = threading.Thread(target=self._send_preview_frames, daemon=True)
    ...
    def _send_preview_frames(self) -> None:
        ...
        while self.recording and self.connected:
            try:
                ...
                preview_msg = create_message('preview_frame',
    ...
    def _send_file_chunks(self) -> None:
        ...
        for chunk_index in range(total_chunks):
            ...
            fake_chunk_data = base64.b64encode(b'fake_video_data_chunk_' + str(chunk_index).encode()).decode()
            
            chunk_msg = create_message('file_chunk',
                                     file_id=file_id,
    ...
    def _send_calibration_result(self) -> None:
        ...
        result_msg = create_message('calibration_result',
                                  success=True,
    ...
    def _send_device_status(self) -> None:
        ...
        status_msg = create_message('device_status',
    ...
    def _generate_fake_image(self) -> str:
        ...
        fake_data = b'\xff\xd8\xff\xe0' + b'fake_jpeg_data_' + str(self.frame_counter).encode() + b'\xff\xd9'
...
class FakeDeviceManager:
    ...
    def add_device(self, device_id: str, host: Optional[str] = None, 
                   port: Optional[int] = None) -> FakeAndroidDevice:
