...
class TestPythonAndroidIntegration(unittest.TestCase):
    ...
    def test_shimmer_failover_protocol(self):
        ...
        if devices:
            ...
            recording_result = self.shimmer_manager.start_recording(failover_request['session_id'])
            if recording_result:
    ...
    def _check_protocol_compatibility(self, python_version: str, android_version: str) -> bool:
