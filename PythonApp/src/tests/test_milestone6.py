...
class TestMilestone6(unittest.TestCase):
    ...
    def test_config_manager_loads_constants_correctly(self):
        ...
        self.assertEqual(
            self.config_manager.get("calibration.pattern_type"), "chessboard"
        )
    ...
    def test_handshake_message_creation(self):
        ...
        with patch.object(
            self.handshake_manager, "schema_manager", self.schema_manager
        ):
            self.schema_manager.create_message.return_value = {
                "type": "handshake",
                "timestamp": 1234567890,
    ...
    def test_handshake_ack_creation(self):
        ...
        with patch.object(
            ...
            handshake_ack = self.handshake_manager._create_handshake_ack(
                compatible=True, message="Test compatibility"
            )
    ...
    def test_handshake_processing(self):
        ...
        with patch.object(
            ...
            compatible, message = self.handshake_manager.process_handshake(
                compatible_handshake
            )
    ...
    def test_config_default_values(self):
        ...
        self.assertEqual(
            self.config_manager.get("non.existent.key", "default"), "default"
        )
