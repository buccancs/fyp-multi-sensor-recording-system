...
class CalibrationProcessor:
    ...
    def __init__(self):
        ...
        # Pattern configuration for backward compatibility
        self.pattern_size = (9, 6)  # Default chessboard pattern size
    ...
    def find_calibration_corners(self, image: np.ndarray) -> dict:
        """
        Find calibration corners in an image (backward compatibility method).
        
        Args:
            image (np.ndarray): Input image
            
        Returns:
            dict: Result dictionary with 'success' and 'corners' or 'error' keys
        """
        try:
            ...
            if success:
                ...
                return {
                    "success": False,
                    "error": "No chessboard pattern detected"
                }
        except Exception as e:
            return {
                "success": False,
                "error": f"Corner detection failed: {str(e)}"
            }
