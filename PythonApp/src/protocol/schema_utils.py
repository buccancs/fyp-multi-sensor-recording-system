...
class SchemaManager:
    ...
    def get_message_template(self, message_type: str) -> Dict[str, Any]:
        ...
        templates = {
            ...
            'preview_frame': {
                'type': 'preview_frame', 'timestamp': 0, 'frame_id': 0,
                'image_data': '', 'width': 0, 'height': 0
            },
            'file_chunk': {
                'type': 'file_chunk', 'timestamp': 0, 'file_id': '',
                'chunk_index': 0, 'total_chunks': 0, 'chunk_data': '',
                'chunk_size': 0, 'file_type': 'video'
            },
            'device_status': {
                'type': 'device_status', 'timestamp': 0, 'device_id': '', 'status': 'idle'
            },
            'ack': {
                'type': 'ack', 'timestamp': 0, 'message_id': '', 'success': True
            },
            'calibration_start': {
                'type': 'calibration_start', 'timestamp': 0, 'pattern_type': 'chessboard',
                'pattern_size': {'rows': 7, 'cols': 6}
            },
            'calibration_result': {
                'type': 'calibration_result', 'timestamp': 0, 'success': False
            }
        }
