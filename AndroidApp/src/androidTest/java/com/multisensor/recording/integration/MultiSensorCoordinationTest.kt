...
class MultiSensorCoordinationTest {
    ...
    @Test
    fun testMultiSensorSessionCreation() = runTest {
    ...
    @Test
    fun testSensorCoordinationTiming() = runTest {
        ...
        assertTrue("All sensors ready within reasonable time", 
                  (allSensorsReady - testSessionInfo.startTime) < 1000) // Within 1 second
        
        logger.info("[DEBUG_LOG] Sensor coordination timing verified")
    }

    @Test
    fun testSessionDataIntegrity() = runTest {
    ...
    @Test
    fun testResourceCoordination() = runTest {
    ...
    @Test
    fun testSensorFailureRecovery() = runTest {
        ...
        val recoverySessionInfo = testSessionInfo.copy(
            errorOccurred = false,
            errorMessage = null
        )
    ...
    @Test
    fun testConcurrentSensorOperations() = runTest {
    ...
    @Test
    fun testSessionLifecycleWithMultipleSensors() = runTest {
    ...
    fun testDataSynchronization() = runTest {
        ...
        assertTrue("Thermal timestamp should be close to video", 
                  Math.abs(thermalTimestamp - videoTimestamp) < 50)
        assertTrue("RAW timestamp should be close to thermal", 
    ...
    @Test
    fun testStorageCoordination() = runTest {
    ...
    @Test
    fun testErrorHandlingAcrossSensors() = runTest {
