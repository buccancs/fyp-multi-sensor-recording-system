...
class FileIOIntegrationTest {
    ...
    @Test
    fun testSessionFolderCreation() = runTest {
    ...
    @Test
    fun testFilePathGeneration() = runTest {
        ...
        filePaths?.let { paths ->
            ...
            assertEquals("RGB video parent should be session folder", 
                        paths.sessionFolder, paths.rgbVideoFile.parentFile)
            assertEquals("Thermal video parent should be session folder", 
                        paths.sessionFolder, paths.thermalVideoFile.parentFile)
            assertEquals("RAW frames parent should be session folder", 
                        paths.sessionFolder, paths.rawFramesFolder.parentFile)
            assertEquals("Shimmer data parent should be session folder", 
                        paths.sessionFolder, paths.shimmerDataFile.parentFile)
            assertEquals("Log file parent should be session folder", 
                        paths.sessionFolder, paths.logFile.parentFile)
        }
    ...
    @Test
    fun testVideoFileOperations() = runTest {
        ...
        videoFile?.let { file ->
            ...
            // Verify file content
            val readData = FileInputStream(file).use { input ->
                input.readBytes()
            }
    ...
    @Test
    fun testRAWImageFileOperations() = runTest {
    ...
    @Test
    fun testThermalDataFileOperations() = runTest {
        ...
        sessionFolder?.let { folder ->
            ...
            // Verify file content
            val readData = FileInputStream(thermalFile).use { input ->
                input.readBytes()
            }
    ...
    @Test
    fun testLogFileOperations() = runTest {
        ...
        logFile?.let { file ->
            ...
            // Verify log content
            val logContent = FileInputStream(file).use { input ->
    ...
    @Test
    fun testShimmerDataFileOperations() = runTest {
        ...
        shimmerFile?.let { file ->
            ...
            // Verify CSV content
            val csvContent = FileInputStream(file).use { input ->
                String(input.readBytes())
            }
    ...
    @Test
    fun testFileIntegrityValidation() = runTest {
    ...
    @Test
    fun testStorageSpaceHandling() = runTest {
    ...
    @Test
    fun testFileCleanupOnSessionEnd() = runTest {
