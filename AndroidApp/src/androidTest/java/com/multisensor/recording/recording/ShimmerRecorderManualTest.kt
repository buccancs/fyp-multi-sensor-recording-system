...
class ShimmerRecorderManualTest {
     ...
     */
    @Test
    fun test01_InitialSetupAndPairing() = runBlocking {
        println("[DEBUG_LOG] === Test 1: Initial Setup & Pairing ===")
        
        // Step 1: Initialize ShimmerRecorder
        val initialized = withTimeout(TEST_TIMEOUT_MS) {
        ...
        discoveredDevices = withTimeout(TEST_TIMEOUT_MS) {
        ...
        val shimmerPairedCount = pairedDevices.count { device ->
     ...
     */
    @Test
    fun test03_MultiDeviceConnection() = runBlocking {
        ...
        val connectionSuccess = withTimeout(DEVICE_CONNECTION_TIMEOUT_MS) {
     ...
     */
    @Test
    fun test04_ChannelSelection() = runBlocking {
     ...
     */
    @Test
    fun test05_RecordingSessionIntegration() = runBlocking {
        ...
        val recordingStarted = withTimeout(TEST_TIMEOUT_MS) {
        ...
        val shimmerFiles = sessionFolder.listFiles { file -> 
     ...
     */
    @Test
    fun test06_RealtimePCStreaming() = runBlocking {
     ...
     */
    @Test
    fun test07_DisconnectionAndReconnection() = runBlocking {
     ...
     */
    @Test
    fun test08_DataVerification() = runBlocking {
     ...
     */
    @Test
    fun test09_MultiDeviceSynchronization() = runBlocking {
     ...
     */
    @Test
    fun test10_ResourceCleanup() = runBlocking {
        ...
        val sessionFolders = baseFolder.listFiles { file -> 
     ...
     */
    @Test
    fun testComplete_ShimmerHardwareValidation() = runBlocking {
        println("[DEBUG_LOG] ========================================")
