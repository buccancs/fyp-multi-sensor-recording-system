...
object AllAndroidPermissions {
    ...
    private fun getCorePermissions(): List<String> = listOf(
    ...
    private fun getCameraAndAudioPermissions(): List<String> = listOf(
    ...
    private fun getNetworkPermissions(): List<String> = listOf(
    ...
    private fun getDeviceAdminPermissions(): List<String> = listOf(
    ...
    fun getDangerousPermissions(): Array<String> {
        ...
        // Location
        dangerousPermissions.addAll(listOf(
            Manifest.permission.ACCESS_FINE_LOCATION,
            Manifest.permission.ACCESS_COARSE_LOCATION
        ))
     ...
     */
    fun getPermissionGroupDescriptions(): Map<String, String> = mapOf(
