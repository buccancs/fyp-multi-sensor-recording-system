...
/**
 * Interface for streaming preview frames to external controllers.
 * This decouples the preview streaming logic from the CameraRecorder.
 */
...
/**
 * Implementation that uses ControllerConnectionManager for streaming.
 * This provides the same functionality as PreviewStreamer but uses the abstraction layer.
 */
@ServiceScoped
class NetworkPreviewStreamer @Inject constructor(
    ...
    private suspend fun compressFrame(image: Image): ByteArray = withContext(Dispatchers.Default) {
        ...
        // In a real implementation, you'd convert the Image to JPEG with the specified quality
