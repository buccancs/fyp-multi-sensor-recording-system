...
object NetworkProtocol {
    ...
    object MessageFormat {
         ...
         */
        fun createAck(operation: String): String = createResponse(Responses.ACK, operation)
    ...
    object Validation {
         ...
         */
        fun isValidCommand(command: String): Boolean = VALID_COMMANDS.contains(command.uppercase())

        /**
         * Validate if a response is supported
         */
        fun isValidResponse(response: String): Boolean = VALID_RESPONSES.contains(response.uppercase())
