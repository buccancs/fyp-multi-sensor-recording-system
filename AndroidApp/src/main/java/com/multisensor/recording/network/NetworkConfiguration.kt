...
class NetworkConfiguration @Inject constructor(
     ...
     */
    fun getLegacyPort(): Int {
        return sharedPreferences.getInt(KEY_LEGACY_PORT, DEFAULT_LEGACY_PORT)
    }
     ...
     */
    fun getJsonPort(): Int {
        return sharedPreferences.getInt(KEY_JSON_PORT, DEFAULT_JSON_PORT)
    }
    ...
    fun isCustomConfiguration(): Boolean {
        return getServerIp() != DEFAULT_SERVER_IP ||
