...
class SessionManager @Inject constructor(
     ...
     */
    suspend fun getAllSessions(): List<com.multisensor.recording.recording.SessionInfo> = withContext(Dispatchers.IO) {
    ...
    private fun reconstructSessionInfo(sessionFolder: File): com.multisensor.recording.recording.SessionInfo? {
        return try {
            ...
            val sessionInfo = com.multisensor.recording.recording.SessionInfo(
                sessionId = sessionId,
     ...
     */
    suspend fun deleteAllSessions(): Boolean = withContext(Dispatchers.IO) {
        return@withContext try {
            val baseFolder = getBaseRecordingFolder()
