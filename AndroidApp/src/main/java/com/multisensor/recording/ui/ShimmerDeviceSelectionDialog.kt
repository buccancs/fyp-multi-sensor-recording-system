...
/**
 * Dialog for discovering and selecting Shimmer devices, similar to ShimmerBluetoothDialog
 * from the official Shimmer Android API example.
 */
    ...
    private fun startDeviceScan() {
        lifecycleScope.launch {
            try {
                ...
                // For now, just refresh paired devices as live scanning requires more complex permission handling
                withContext(Dispatchers.IO) {
                    kotlinx.coroutines.delay(2000) // Simulate scan time
                }
