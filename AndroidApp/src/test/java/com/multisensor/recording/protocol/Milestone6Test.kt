...
class Milestone6Test {
    ...
    fun testHandshakeAckMessageCreation() {
        ...
        val handshakeAck = handshakeManager.createHandshakeAck(
    ...
    fun testBasicMessageValidation() {
        ...
        val validMessage = JSONObject().apply {
    ...
    fun testHandshakeProcessing() {
        ...
        val compatibleAck = JSONObject().apply {
        ...
        val incompatibleAck = JSONObject().apply {
            put("type", "handshake_ack")
            put("timestamp", System.currentTimeMillis())
