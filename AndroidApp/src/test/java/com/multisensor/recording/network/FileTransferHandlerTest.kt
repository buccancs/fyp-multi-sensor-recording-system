...
class FileTransferHandlerTest {
    ...
    @Test
    fun `test handleSendFileCommand with valid file`() = runTest {
        // Arrange
        val command = SendFileCommand(
    ...
    @Test
    fun `test handleSendFileCommand with non-existent file`() = runTest {
        // Arrange
    ...
    @Test
    fun `test file chunking with small file`() = runTest {
        // Arrange
    ...
    @Test
    fun `test file chunking with large file`() = runTest {
    ...
    @Test
    fun `test file size validation - file too large`() = runTest {
        // Arrange
    ...
    @Test
    fun `test Base64 encoding in file chunks`() = runTest {
        // Arrange
        ...
        try {
            ...
            verify { 
                mockJsonSocketClient.sendMessage(match<FileChunkMessage> { 
