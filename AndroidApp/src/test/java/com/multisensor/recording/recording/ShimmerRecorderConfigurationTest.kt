...
class ShimmerRecorderConfigurationTest {
    ...
    @Test
    fun `scanAndPairDevices should return list of discovered devices`() = runTest {
    ...
    @Test
    fun `connectDevices should handle empty device list`() = runTest {
    ...
    @Test
    fun `connectDevices should handle valid device addresses`() = runTest {
    ...
    @Test
    fun `setEnabledChannels should configure sensor channels correctly`() = runTest {
    ...
    @Test
    fun `setEnabledChannels should handle invalid device ID`() = runTest {
    ...
    @Test
    fun `setEnabledChannels should handle empty channel set`() = runTest {
    ...
    @Test
    fun `startStreaming should return appropriate result`() = runTest {
    ...
    @Test
    fun `stopStreaming should return appropriate result`() = runTest {
    ...
    @Test
    fun `getShimmerStatus should return valid status information`() = runTest {
    ...
    @Test
    fun `startRecording should handle valid session ID`() = runTest {
    ...
    @Test
    fun `startRecording should handle empty session ID`() = runTest {
    ...
    @Test
    fun `stopRecording should complete successfully`() = runTest {
    ...
    @Test
    fun `getCurrentReadings should return sensor data when available`() = runTest {
    ...
    @Test
    fun `startSDLogging should return appropriate result`() = runTest {
    ...
    @Test
    fun `stopSDLogging should return appropriate result`() = runTest {
    ...
    @Test
    fun `cleanup should complete without errors`() = runTest {
    ...
    @Test
    fun `multiple sensor channels configuration should work correctly`() = runTest {
    ...
    @Test
    fun `device connection state management should work correctly`() = runTest {
        ...
        println("[DEBUG_LOG] Connection state management test passed - connect result: $connectResult, status available: ${status.isAvailable}")
    }
}
