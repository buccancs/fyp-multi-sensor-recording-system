...
class AdaptiveFrameRateControllerTest {
    ...
    fun testFrameRateSettingsDataClass() {
        ...
        val settings = AdaptiveFrameRateController.FrameRateSettings(
    ...
    fun testListenerErrorHandling() {
        ...
        val faultyListener = object : AdaptiveFrameRateController.FrameRateChangeListener {
