...
/**
 * Pure Kotlin unit tests for SessionInfo data class (no Android dependencies)
...
class SessionInfoUnitTest {
    ...
    @Test
    fun `edge case - very long session duration`() {
        // Given
        val startTime = 1000L
    ...
    @Test
    fun `edge case - negative timestamps should still work`() {
    ...
    @Test
    fun `edge case - empty string file paths should be handled`() {
        // Given
