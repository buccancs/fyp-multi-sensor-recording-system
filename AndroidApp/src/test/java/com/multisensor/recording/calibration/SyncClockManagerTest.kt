...
class SyncClockManagerTest {
    ...
    fun testSyncStatusDataClass() {
        ...
        val syncStatus = SyncClockManager.SyncStatus(
            isSynchronized = true,
            clockOffsetMs = 1500L,
    ...
    fun testSuccessfulClockSynchronization() = runTest {
        ...
        assertTrue("Last sync timestamp should be recent", 
    ...
    @Test
    fun testClockSynchronizationWithNegativeOffset() = runTest {
    ...
    @Test
    fun testInvalidPcTimestamp() = runTest {
    ...
    @Test
    fun testSyncedTimestampCalculation() = runTest {
        ...
        assertTrue("Offset should be approximately 3000ms", 
            abs((syncedTime - deviceTime) - 3000L) < 100L) // Allow 100ms tolerance
    ...
    fun testCurrentSyncedTime() = runTest {
        ...
        assertTrue("Time difference should be approximately 1000ms",
            abs((currentSyncedTime - currentDeviceTime) - 1000L) < 200L) // Allow 200ms tolerance
    ...
    @Test
    fun testSyncValidityExpiration() = runTest {
    ...
    @Test
    fun testDeviceToPcTimeConversion() = runTest {
        ...
        assertTrue("Time difference should be approximately 5000ms",
    ...
    @Test
    fun testPcToDeviceTimeConversion() = runTest {
        ...
        assertTrue("Time difference should be approximately 3000ms",
    ...
    @Test
    fun testSyncStatisticsGeneration() = runTest {
    ...
    @Test
    fun testNetworkLatencyEstimation() = runTest {
    ...
    @Test
    fun testSyncHealthValidation() = runTest {
    ...
    @Test
    fun testConcurrentSynchronization() = runTest {
