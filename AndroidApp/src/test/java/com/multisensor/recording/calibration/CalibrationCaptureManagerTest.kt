...
class CalibrationCaptureManagerTest {
    ...
    fun testCalibrationCaptureResultDataClass() {
        ...
        val result = CalibrationCaptureManager.CalibrationCaptureResult(
            success = true,
    ...
    @Test
    fun testSuccessfulDualCameraCapture() = runTest {
    ...
    @Test
    fun testRgbOnlyCapture() = runTest {
    ...
    @Test
    fun testThermalOnlyCapture() = runTest {
    ...
    @Test
    fun testCameraFailureHandling() = runTest {
    ...
    @Test
    fun testAutoGeneratedCalibrationId() = runTest {
    ...
    @Test
    fun testSyncTimestampIntegration() = runTest {
    ...
    fun testCalibrationSessionDataClass() {
        ...
        val session = CalibrationCaptureManager.CalibrationSession(
    ...
    @Test
    fun testConcurrentCaptureOperations() = runTest {
