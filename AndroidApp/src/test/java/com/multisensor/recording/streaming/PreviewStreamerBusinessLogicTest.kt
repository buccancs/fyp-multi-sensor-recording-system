...
class PreviewStreamerBusinessLogicTest {
    ...
    fun `StreamingStats should initialize with correct values`() {
        // When
        val stats = PreviewStreamer.StreamingStats(
            isStreaming = true,
            frameCount = 100L,
            targetFps = 30,
            jpegQuality = 80,
    ...
    fun `StreamingStats should support data class functionality`() {
        // Given
        val stats1 = PreviewStreamer.StreamingStats(
            isStreaming = true,
            frameCount = 50L,
            targetFps = 15,
            jpegQuality = 85,
        ...
        val stats2 = PreviewStreamer.StreamingStats(
            isStreaming = true,
            frameCount = 50L,
            targetFps = 15,
            jpegQuality = 85,
        ...
        val stats3 = PreviewStreamer.StreamingStats(
            isStreaming = false,
            frameCount = 50L,
            targetFps = 15,
            jpegQuality = 85,
    ...
    fun `StreamingStats should support copy functionality`() {
        // Given
        val original = PreviewStreamer.StreamingStats(
            isStreaming = false,
            frameCount = 75L,
            targetFps = 10,
            jpegQuality = 60,
