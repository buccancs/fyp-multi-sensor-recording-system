...
class SessionManagerTest {
    ...
    @Test
    fun `createNewSession should generate unique session ID`() = runTest {
        // When
    ...
    @Test
    fun `createNewSession should create active session`() = runTest {
        // When
        val sessionId = sessionManager.createNewSession()
    ...
    @Test
    fun `finalizeCurrentSession should handle no active session gracefully`() = runTest {
    ...
    @Test
    fun `getSessionFilePaths should return proper file paths for active session`() = runTest {
        // Given
        sessionManager.createNewSession()
    ...
    @Test
    fun `multiple sessions should have unique IDs and folders`() = runTest {
    ...
    @Test
    fun `session timing should be tracked correctly`() = runTest {
        // Given
    ...
    @Test
    fun `SessionFilePaths should create raw_frames directory`() = runTest {
        // Given
        sessionManager.createNewSession()
    ...
    @Test
    fun `session folder should have proper naming format`() = runTest {
        // When
        sessionManager.createNewSession()
        val session = sessionManager.getCurrentSession()
    ...
    @Test
    fun `SessionFilePaths data class should have all required properties`() = runTest {
        // Given
        sessionManager.createNewSession()
        val filePaths = sessionManager.getSessionFilePaths()
