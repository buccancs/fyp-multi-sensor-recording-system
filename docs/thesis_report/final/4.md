...
This study has been approved by the UCLIC Ethics Committee with Project ID: 1428. The ethics approval covers the research methodology, participant recruitment procedures, data collection protocols, and data handling procedures described in this thesis. The approved research protocol includes provisions for participant information sheets, informed consent procedures, and risk assessment protocols that ensure participant safety and data protection throughout the research process.
...
This research has obtained appropriate ethics approval from the UCLIC Ethics Committee (Project ID: 1428), which includes:

1. **Approved research methodology**: The ethics approval covers the experimental design, data collection procedures, and analysis framework presented in this thesis
2. **Participant information and consent procedures**: Standardised information sheets and informed consent protocols have been approved for participant recruitment and data collection
3. **Risk assessment protocols**: Comprehensive risk assessment covering technical, safety, and data protection aspects has been reviewed and approved by the supervisor and ethics committee
4. **Data management framework**: Approved procedures for data collection, storage, anonymisation, and retention that comply with UCL data protection policies and GDPR requirements
5. **Participant protection measures**: Clear protocols for participant withdrawal, data deletion, and ongoing safety monitoring throughout research sessions
