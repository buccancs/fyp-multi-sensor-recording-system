...
into Python tuples \[1\], \[2\]. This design minimises overhead,
...
time synchronisation strategy. When the PC and a phone connect, they
...
- **Cross-Platform Performance in the PC App:** Python is interpreted
  ...
  a queue \[1\], \[2\]. As C++ code, it's compiled and optimised,
