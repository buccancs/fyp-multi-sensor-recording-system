...
For the technical development and validation phases of this project, no human participants were directly involved in data collection, thus formal ethics approval from the UCL Research Ethics Committee was not required for the system design and implementation work presented in this thesis. However, any future deployment of this system for research involving human participants would require appropriate ethics approval from the relevant UCL ethics committee prior to data collection.
...
Any research deployment of this system would require researchers to:

1. Obtain appropriate ethics approval specifying the research context, participant population, and data usage protocols
2. Implement informed consent procedures explaining data collection types, storage duration, and participant rights
3. Establish data sharing agreements if multi-institutional collaboration is involved
4. Provide participants with clear information about their right to withdraw and data deletion procedures
5. Ensure compliance with institution-specific data management policies and any discipline-specific ethical guidelines
