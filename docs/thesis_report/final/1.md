...
nervous system [Boucsein(2012)]. These involuntary changes reflect emotional
arousal and stress, making GSR a widely accepted indicator of autonomic
nervous system activity [Boucsein(2012)]. GSR is used in clinical psychology (e.g.,
...
stress monitoring via GSR or related metrics [Neural Sense(2024)]. This surge of
...
[Jangra et al.(2021)]. This method is obtrusive: wires and electrodes restrict movement,
and long-term use can cause discomfort or skin irritation [Jangra et al.(2021)]. These limitations make it difficult to use GSR outside the lab.
Consequently, **contactless GSR measurement** has become an appealing
research direction [Nature Scientific Reports(2019)]. The idea is to infer GSR (or the underlying
...
offering a proxy for stress responses [Computer Modeling in Engineering(2021)].
...
(e.g., perspiration causes cooling) [Computer Modeling in Engineering(2021)]. Similarly, high-resolution
...
[RTI International(2024)]. These developments suggest that *multi-modal sensing* ---
...
not synchronised in real time [Science Direct(2025)]. For instance, thermal
...
[Shimmer Sensing(2024)]. Bridging this gap requires a platform that records **multiple
...
- **Objective 1: Multi-Modal Platform Development.** *Design and develop
  ...
  the system uses a **research-grade** Shimmer3 GSR+ sensor [Shimmer Sensing(2024)] for
...
- **Objective 2: Synchronised Data Acquisition and Management.**
  *Implement methods for precise time synchronisation and data handling
  ...
  transmit control commands and streaming data [LSL Community(2024)]. Data management
...
- **Chapter 4 \-- System Design and Architecture:** This chapter
  ...
  hub and a PC as the central controller [LSL Community(2024)]). The chapter details
