...
be later aligned for machine learning[Boucsein(2012)]. Overall, the system's goal
...
research-driven approach** [Selye(1956)]. Initially, high-level objectives (e.g.
...
[Selye(1974)]. Each requirement was documented with a unique ID and categorised
...
- **FR3: Time Synchronisation Service** \-- The system shall synchronise
  ...
  PC's clock before and during recording ]6\]. This achieves a
...
- **FR8: Fault Tolerance and Recovery** \-- If a device (Android or
  ...
  doesn't invalidate the entire session.
