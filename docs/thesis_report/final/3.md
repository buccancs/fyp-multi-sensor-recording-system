...
research-driven approach** \[2\]. Initially, high-level objectives (e.g.
...
\[3\]. Each requirement was documented with a unique ID and categorised
...
real-time. -- The **Time Synchronization Service** (Master Clock) runs
