...
As illustrated in Figure 2.1, the emotion/stress sensing landscape encompasses both **behavioral modalities** (RGB facial expression, body pose, speech) and **physiological modalities** (GSR/EDA, PPG/HRV, thermal imaging). This has motivated the integration of **wearable sensors** and
