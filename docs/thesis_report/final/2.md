...
interfaces or social robots [4]. For example, **galvanic skin response
...
testing*, and *neuromarketing* [5]. In psychological research, changes
in skin conductance have been analyzed to understand anxiety during
therapy or excitement during gameplay [5]. In **human-computer
...
engagement with software interfaces [5]. Even in critical domains such
