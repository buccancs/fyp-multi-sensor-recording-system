...
(BLE)} is also
supported\cite{ref10}【12†L388-L396\textbf{,
...
appropriate)\cite{ref16}\cite{ref17}.
...
\texttt{GSR_kOhms = (1 / (p1}raw + p2)) \textit{ 1000}\cite{ref22},
...
\item There's a troubleshooting step in the Shimmer User Guide where you can
  ...
  functioning\cite{ref42}\cite{ref43}.
