...
timestamp\cite{ref11}\cite{ref12}.
...
to the desktop
controller\cite{ref13}\cite{ref14}.
...
scan/connect)\cite{ref25}\cite{ref26}.
...
or Shimmer) nearly
simultaneously\cite{ref32}\cite{ref33}.
...
correctly\cite{ref37}\cite{ref38}.
...
accumulate)\cite{ref48}\cite{ref49}.
...
real-time\cite{ref51}\cite{ref36}.
