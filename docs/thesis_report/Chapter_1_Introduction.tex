...
\texttt{AndroidApp/src/main/java/com/multisensor/recording/MainActivity.kt} and \texttt{PythonApp/src/main.py}.
...
\texttt{PythonApp/src/webcam/webcam\_capture.py}.
...
\texttt{PythonApp/src/shimmer\_manager.py}.
...
implemented in \texttt{PythonApp/src/main.py} and comprehensive documentation following software engineering best
