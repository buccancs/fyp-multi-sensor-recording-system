...
class SyntheticDataGenerator:
    ...
    def __init__(self, seed: Optional[int] = None):
        ...
        self.gsr_baseline = 0.8
        self.gsr_baseline_drift_rate = 0.01
        self.gsr_noise_amplitude = 0.05
        self.gsr_stress_spike_probability = 0.001
        ...
        self.thermal_base_temp = 25.0
        self.thermal_hotspot_temp = 35.0
        self.start_time = 0.0
    ...
    def generate_gsr_sample(self) -> float:
        ...
        if self.gsr_stress_event_timer > 0:
            ...
            self.gsr_stress_event_timer += 1.0 / 128.0
            ...
            if self.random_generator.random() < self.gsr_stress_spike_probability:
                ...
                self.gsr_stress_amplitude = self.random_generator.uniform(0.3, 1.0)
    ...
    def generate_rgb_frame(self) -> bytes:
        ...
        try:
            ...
            compressed_size = len(frame_bytes) // 10
    ...
    def generate_thermal_frame(self) -> bytes:
        ...
        try:
            ...
            dummy_size = self.thermal_width * self.thermal_height * 2
...
class MultiDeviceDataGenerator:
    ...
    def generate_synchronized_gsr_samples(self) -> List[float]:
        ...
        for generator in self.generators:
            ...
            samples.append(max(0.1, adjusted_sample))
        return samples
